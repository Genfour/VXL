...
const Home = () => {
    ...
    const handleMouseEnter = () => {
        if (window.innerWidth > 992) { // Only apply hover effect for desktop view
    ...
    const handleDropdownClick = () => {
        if (window.innerWidth <= 992) { // Only toggle dropdown on click for mobile view
    ...
    return (
        <>
            ...
            <nav
                ...
                className="navbar-expand-lg navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn"
                data-wow-delay="0.1s"
            >
                ...
                >
                    <span style={{marginLeft: '10%'}} className="navbar-toggler-icon"></span>
                </button>
                <div
                    className={`collapse navbar-collapse justify-content-between py-4 py-lg-0 ${isMobileMenuOpen ? "show" : ""
                        }`}
                    id="navbarCollapse"
                >
                    <div className="navbar-nav ms-auto py-0">
                        <a href="#home" className="nav-item nav-link" style={{ color: "#fff" }}>
                            Home
                        </a>
                        <a href="#about" className="nav-item nav-link" style={{ color: "#fff" }}>
                            About
                        </a>
                        ...
                        <div
                            ...
                            style={{ color: "#fff", position: "relative", cursor: "pointer" }}
                        ...
                        >
                            ...
                            {/* Dropdown Menu */}
                            {dropdownVisible && (
                                <div className="dropdown-menu show" style={{ position: "absolute", top: "100%", left: "0", backgroundColor: "#fff" }}>
                                    ...
                                    <a href="/service" className="dropdown-item">
                                        Skilled Migration
                                    </a><a href="/service" className="dropdown-item">
                                        Career Counselling
                                    </a>
                                </div>
                            )}
                    ...
                    <div className="navbar-nav me-auto py-0">
                        <a href="#project" className="nav-item nav-link" style={{ color: "#fff" }}>
                            Projects
                        </a>
                        <a href="#team" className="nav-item nav-link" style={{ color: "#fff" }}>
                            Team
                        </a>
                        <a href="#contact" className="nav-item nav-link" style={{ color: "#fff" }}>
                            Contact
                        </a>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                            <h3 class="text-primary mb-3">We're</h3>
                            <h1 class="display-3 mb-3">VXL Education Sri Lanka</h1>
                    ...
                    <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="col-lg-6 text-lg-end">
                            <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                                <li className={`mx-3 ${filter === "*" ? "active" : ""}`}
                                    onClick={() => handleFilterChange("*")}>All Projects</li>

                                <li className={`mx-3 ${filter === "UI/UX Design" ? "active" : ""}`}
                                    onClick={() => handleFilterChange("UI/UX Design")}>category 1</li>

                                <li className={`mx-3 ${filter === "Graphic Design" ? "active" : ""}`}
                                    onClick={() => handleFilterChange("Graphic Design")}>category 2</li>
                            </ul>
                        </div>
                    </div>
